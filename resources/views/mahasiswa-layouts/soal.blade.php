                ...
                <div class="border">
                    ...
                    <div class="question bg-white p-3 border-bottom">
                        ...
                        <div class="ans d-block">
                            <label class="radio w-100"> <input type="radio" name="jawaban" value="brazil"> <span class="w-100">Brazil</span>
                            </label>
                        </div>
                        <div class="ans d-block">
                            <label class="radio w-100"> <input type="radio" name="jawaban" value="Germany"> <span class="w-100">Germany</span>
                            </label>
                        </div>
                        <div class="ans d-block">
                        ...
                        <div class="ans d-block " >
                            <label class="radio w-100"> <input type="radio" name="jawaban" value="Russia"> <span class="w-100">Lorem ipsum dolor sit amet .</span>
                            </label>
                        </div>
                    </div>
